...
function resolveDirectiveActivation(directive, task) {
	...
	if (!scopeMatchesTask(directive.scope.path, task)) return buildSkippedDecision(directive, "scope-mismatch", "directive scope does not match target or changed files");
	return {
...
//#endregion
export { activatedDirectiveIdsIR, resolveActivationDecisionsIR };
